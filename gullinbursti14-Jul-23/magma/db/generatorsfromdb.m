...
load "gullinbursti14-Jul-23/magma/db/readfromdb.m";
load "gullinbursti14-Jul-23/magma/db/parsegenerators.m";

PATH_TO_DB:="gullinbursti14-Jul-23/db";
...
/*given integers d,n and a signature:
	...
	"abelianization" if the abelianization cannot be generated by a set of elements with the indicated signature
*/
generatorsFromDb:=function(
G,
signature)
	//G:=SmallGroup(d,n);	// MODIFICA MIA
         d:=Order(G); //MODIFICA MIA
         n:=IdentifyGroup(G)[2]; //MODIFICA MIA		
